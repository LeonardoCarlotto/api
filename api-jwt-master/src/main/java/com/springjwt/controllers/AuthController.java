...
import com.mail.controllers.EmailController;
import com.mail.payload.response.MessageResponse;
import com.springjwt.models.ERole;
import com.springjwt.models.InvalidToken;
import com.springjwt.models.Role;
import com.springjwt.models.User;
import com.springjwt.payload.request.ForgotPassword;
...
import com.springjwt.payload.response.forgotPasswordResponse;
...
public class AuthController {
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody ForgotPassword forgotPassword) {
		...
		if(userRepository.existsByEmail(forgotPassword.getEmail())) {
			...
			String psw = "teste" + ramdom.nextInt();
